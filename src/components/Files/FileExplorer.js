...
class EnhancedTable extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      orderBy: 'name',
      selected: [],
      data: files.map(file => createData(file.name, file.dateModified, file.type, file.size)),
      page: 0,
      rowsPerPage: 10,
    };
  }
  ...
  render() {
    ...
    return (
      <div>
        <EnhancedTableToolbar onChange={this.handlePathChange} numSelected={selected.length} />
        <Divider />
